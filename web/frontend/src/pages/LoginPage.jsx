...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const message = err.response?.data?.message || (err.request ? "Cannot reach backend API. Start backend server on http://localhost:8080." : "Login failed. Please check your credentials.");
